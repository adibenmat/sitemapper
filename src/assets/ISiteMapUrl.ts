...
export interface ISiteMapUrl {
    /**
     * URL of the page. This URL must begin with the protocol (such as http) and end with a
     ...
     * search engines and may not correlate exactly to how often they crawl the page. Valid values are:
